...
# for i in pair_lst:
# 	nums1 = [for i i
# print(time_num([14,14,14,3,14],['D','D', 'C', 'S', 'C']))
# for j in range(len(pair_lst)):
# 	nums1 = [num_dict[i[0]] for i in pair_lst[j][0].split(' ')]
# 	shapes1 = [i[1] for i in pair_lst[j][0].split(' ')]
# 	print(f'{pair_lst[j][0]} -> {time_num(nums1, shapes1)}')